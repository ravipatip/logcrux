...
See [docs/06-supported-log-types.md](docs/06-supported-log-types.md) for the full breakdown by category and a complete alphabetical index of all 209 parsers.
