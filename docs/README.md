...
Welcome to the **logcrux** documentation. This folder contains comprehensive guides covering all aspects of logcrux — an intelligent, fully local log analyzer.
...
- **[Supported Log Types](./06-supported-log-types.md)** — Complete list of every log format parser with examples (the canonical count lives here)
...
### AI & Classification
- **[Inference System](./11-inference-system.md)** — Local AI classification
...
**logcrux** is a command-line tool that analyzes logs to detect anomalies, security incidents, and system failures without requiring external APIs or cloud connectivity. It combines:
...
### Key Stats
- **200+ log format parsers** covering system/auth, web servers, databases, cloud-native, SIEM, observability, and more, plus a generic fallback for anything else
...
├── 06-supported-log-types.md          Every parser listed (canonical count)
