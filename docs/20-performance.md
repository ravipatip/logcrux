...
Measured with logcrux 0.9.0 against an nginx access log at 1K and 101K
events; the XL/XXL rows extrapolate the per-event cost and have not been
run. Times are hardware-dependent; the memory shape is structural.
